...
// ---------------------------------------------------------
PhysBody3D* ModulePhysics::AddBody(const Sphere& sphere, float mass)
{
...
// ---------------------------------------------------------
PhysBody3D* ModulePhysics::AddBody(const Cube& cube, Module* listener, float mass, bool sensor)
{
...
// ---------------------------------------------------------
PhysBody3D* ModulePhysics::AddBody(const Cylinder& cylinder, float mass)
{
...
PhysBody3D* ModulePhysics::AddBody(const Cube& cube, float mass)
{
	btCollisionShape* colShape = new btBoxShape(btVector3(cube.size.x * 0.5f, cube.size.y * 0.5f, cube.size.z * 0.5f));
	shapes.add(colShape);
...
// ---------------------------------------------------------
void ModulePhysics::AddConstraintP2P(PhysBody3D& bodyA, PhysBody3D& bodyB, const vec3& anchorA, const vec3& anchorB)
{
...
void ModulePhysics::AddConstraintHinge(PhysBody3D& bodyA, PhysBody3D& bodyB, const vec3& anchorA, const vec3& anchorB, const vec3& axisA, const vec3& axisB, bool disable_collision)
{
